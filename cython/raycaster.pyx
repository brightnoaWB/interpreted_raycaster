...
def raycaster():
    ...
    while True:
        ...
        timer_startframe = pygame.time.get_ticks()
        ...
        timer_endframe = pygame.time.get_ticks()
        timer_delta = timer_startframe - timer_endframe

        # Text logs
        text = "Frame time: " + str(timer_delta) + " / " + str(FRAME_DELAY)
        textsurf = font.render(text, True, WHITE)
        screen.blit(textsurf, (5, 5))

        text = "Resolution: " + str(resolution) + " / " + str(max_resolution)
        textsurf = font.render(text, True, WHITE)
        screen.blit(textsurf, (5, 20))

        text = "Shadow: " + str(draw_shadow)
        textsurf = font.render(text, True, WHITE)
        screen.blit(textsurf, (5, 35))

        text = "Fog: " + str(draw_fog)
        textsurf = font.render(text, True, WHITE)
        screen.blit(textsurf, (5, 50))

        text = "Lines: " + str(draw_line)
        textsurf = font.render(text, True, WHITE)
        screen.blit(textsurf, (5, 65))
        ...
        try:
            ...
            pygame.display.flip()
        if timer_delta < FRAME_DELAY:
            pygame.time.delay(timer_delta)
